...
const fromAccount = (row) => ({
  ...
  authoriserPassword: row.authoriser_password || '',
  checkerUserId: row.checker_user_id || '',
  checkerPassword: row.checker_password || '',
  makerUserId: row.maker_user_id || '',
  makerPassword: row.maker_password || '',
  authoriserUserId: row.authoriser_user_id || '',
  authoriserUserPassword: row.authoriser_user_password || '',
...
const toAccount = (values) => ({
  ...
  authorized_signatory: values.authorizedSignatory || '',
  account_number: values.accountNumber,
  ifsc: values.ifsc,
  branch: values.branch || '',
  account_type: values.accountType || 'Savings Account',
  upi_id: values.upiId || '',
  ...
  atm_pin: values.atmPin || '',
  group_id: values.groupId || '',
  authoriser_password: values.authoriserPassword || '',
  checker_user_id: values.checkerUserId || '',
  checker_password: values.checkerPassword || '',
  maker_user_id: values.makerUserId || '',
  maker_password: values.makerPassword || '',
  authoriser_user_id: values.authoriserUserId || '',
  authoriser_user_password: values.authoriserUserPassword || '',
