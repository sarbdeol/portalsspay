...
class AgentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Agent
        fields = ["id", "name", "full_name", "email", "password", "mobile", "whatsapp", "telegram", "address", "notes", "status", "merchants", "accounts"]
    ...
    def create(self, validated_data):
        ...
        name = validated_data.pop("full_name", user_data["email"].split("@")[0])
        password = validated_data.pop("password", "demo1234")
        user = create_user(user_data["email"], password, name)
        Profile.objects.create(user=user, role="Agent", mobile=validated_data.get("mobile", ""), whatsapp=validated_data.get("whatsapp", ""))
...
class MerchantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Merchant
        fields = ["id", "name", "full_name", "email", "password", "agent_id", "agent_name", "city", "volume", "status", "accounts"]
